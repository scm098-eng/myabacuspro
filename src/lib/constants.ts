...
export const RANK_CRITERIA = [
  { name: "Human Calculator", icon: "👑", color: "#FFD700", daysReq: 360, pointsReq: 1000000, bonusPoints: 50000, description: "The ultimate master. Speed and accuracy beyond all limits." },
  { name: "Grandmaster", icon: "🏆", color: "#E5E4E2", daysReq: 330, pointsReq: 750000, bonusPoints: 35000, description: "Elite status reserved for the most dedicated math warriors." },
  { name: "Math Titan", icon: "🏛️", color: "#94a3b8", daysReq: 300, pointsReq: 500000, bonusPoints: 25000, description: "Unshakable precision and monumental focus." },
  { name: "Supreme Ninja", icon: "⚔️", color: "#475569", daysReq: 210, pointsReq: 350000, bonusPoints: 18000, description: "A legendary force in the world of mental arithmetic." },
