...
export const RANK_CRITERIA = [
  ...
  { name: "Math Titan", icon: "🏛️", color: "#94a3b8", daysReq: 300, pointsReq: 500000, description: "Unshakable precision and monumental focus." },
  { name: "Supreme Ninja", icon: "⚔️", color: "#475569", daysReq: 270, pointsReq: 350000, description: "A legendary force in the world of mental arithmetic." },
  { name: "Math Ninja", icon: "🥷", color: "#C0C0C0", daysReq: 240, pointsReq: 250000, description: "Lightning fast visualization and silent precision." },
  { name: "Senior Calculator", icon: "🎓", color: "#3b82f6", daysReq: 210, pointsReq: 180000, description: "A seasoned expert with immense speed and deep abacus wisdom." },
  { name: "Elite Apprentice", icon: "🎖️", color: "#10b981", daysReq: 180, pointsReq: 120000, description: "A top-tier practitioner nearing absolute mastery." },
  { name: "Master Apprentice", icon: "💎", color: "#06b6d4", daysReq: 150, pointsReq: 85000, description: "Significant expertise across all complex formulas." },
  { name: "Senior Apprentice", icon: "🧮", color: "#6366f1", daysReq: 120, pointsReq: 55000, description: "Advanced skills and deep understanding of abacus logic." },
