...
export default function BirthdayWish() {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="sm:max-w-md text-center border-pink-200 bg-white/90 backdrop-blur-xl shadow-2xl rounded-[2.5rem] overflow-hidden animate-in zoom-in-95">
        ...
        <DialogHeader className="relative z-10">
          ...
          <DialogDescription className="mt-4 text-xl font-bold text-slate-700 leading-relaxed px-4">
            {profile?.firstName}, wishing you a fantastic day filled with math and joy! Keep climbing those ranks, Champion! 🌟
          </DialogDescription>
        </DialogHeader>
