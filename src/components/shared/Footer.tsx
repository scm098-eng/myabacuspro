      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <h2 className="mb-6 text-sm font-semibold text-foreground uppercase tracking-wider">Navigate</h2>
              ...
              <div>
                  <h2 className="mb-6 text-sm font-semibold text-foreground uppercase tracking-wider">Support</h2>
                  <ul className="text-muted-foreground font-medium">
                      <li className="mb-4"><Link href="/contact" className="hover:text-primary transition-colors">Contact us</Link></li>
              ...
              <div>
                  ...
                  <ul className="text-muted-foreground font-medium">
                      <li className="mb-4"><Link href="/privacy" className="hover:text-primary transition-colors">Privacy Policy</Link></li>
                      <li className="mb-4"><Link href="/terms" className="hover:text-primary transition-colors">Terms & Conditions</Link></li>
                      <li><Link href="/cancellation-refund" className="hover:text-primary transition-colors">Cancellation & Refund</Link></li>
                  </ul>
              </div>
          </div>
        </div>
