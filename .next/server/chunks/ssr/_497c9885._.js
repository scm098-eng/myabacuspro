...
function TestCard({ testId, title, description, Icon, iconBg, isFormula = false }) {
    ...
    // Bead tests are free, other formula tests require pro.
    const isLocked = isFormula && !isBeadTest && !isPro;
    const renderLink = (difficulty, children)=>{
        // If it's a locked formula test, the button is disabled, so no link needed.
        if (isLocked) {
...
function BeadsValuePage() {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$usePageBackground$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["usePageBackground"])('https://placehold.co/1920x1080/fffde7/f59e0b?text=.');
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=_497c9885._.js.map