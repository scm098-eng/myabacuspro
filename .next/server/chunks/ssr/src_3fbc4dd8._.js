...
function ProfilePage() {
    ...
    const { user, profile, isLoading, getApprovedTeachers, fetchProfile, updateUserProfile } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    async function onSubmit(values) {
        ...
        try {
            ...
            toast({
                title: "Update Failed",
                description: error.message || "Could not update your profile. Please check the console for details.",
                variant: "destructive"
            });
        } finally{
    ...
    const handleCropConfirm = async ()=>{
        ...
        try {
            ...
            toast({
                title: "Photo Ready",
                description: "Photo cropped successfully. It will be saved when you save your changes."
            });
        } catch (error) {
...
//# sourceMappingURL=src_3fbc4dd8._.js.map