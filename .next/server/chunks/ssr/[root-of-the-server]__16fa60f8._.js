...
function AuthProvider({ children }) {
    ...
    const updateUserProfile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (uid, data)=>{
        const { profilePhoto: photoFileOrList, ...profileData } = data;
        let newPhotoURL = undefined;
        let file = null;
        if (photoFileOrList) {
            if (photoFileOrList instanceof File) {
                file = photoFileOrList;
            } else if (photoFileOrList.length > 0) {
                file = photoFileOrList[0];
            }
        }
        if (file) {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$storage$2f$dist$2f$node$2d$esm$2f$index$2e$node$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uploadBytes"])(storageRef, file);
            newPhotoURL = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$storage$2f$dist$2f$node$2d$esm$2f$index$2e$node$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDownloadURL"])(storageRef);
        }
        ...
        if (newPhotoURL) {
            payload.profilePhoto = newPhotoURL;
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__16fa60f8._.js.map