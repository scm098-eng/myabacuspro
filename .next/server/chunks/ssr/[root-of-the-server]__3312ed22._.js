...
"[project]/src/lib/knowledge-base.ts [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
- **Do I need a physical abacus?**
  While having a physical abacus can be helpful for beginners, it is not required. The "Beads Value" tests and "Tool Preview" page are designed to help you visualize and understand the abacus digitally.

## Abacus Formulas & Techniques

- **What are Small Sister, Big Brother, and Combination formulas?**
...
- **What does the Pro Membership offer?**
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$knowledge$2d$base$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/knowledge-base.ts [app-rsc] (ecmascript)");
...
async function chat(input) {
    try {
        const { history } = input;
        const systemPrompt = `You are a friendly and helpful chatbot assistant for an application called "My Abacus Pro".
    Your goal is to assist users with any questions they have about the app, abacus techniques, mental math, or their account.
    The app helps users practice mental arithmetic using abacus methods.
    Be concise and encouraging in your responses. If you don't know an answer, say so politely.

    Use the following knowledge base to answer questions. Do not make up information.

    <KnowledgeBase>
    ${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$knowledge$2d$base$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["knowledgeBase"]}
    </KnowledgeBase>
    `;
        const { stream } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$genkit$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ai"].generate({
        ...
        // Create a stream that yields an error message
        async function* createErrorStream() {
            yield {
                role: 'model',
                content: [
                    {
                        text: `Sorry, I encountered an error. Please check the server console.`
                    }
                ]
            };
        }
...
"[project]/.next-internal/server/app/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/ai/flows/chatFlow.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>": ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/ai/flows/chatFlow.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s({});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$chatFlow$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/ai/flows/chatFlow.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$ai$2f$flows$2f$chatFlow$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/page/actions.js { ACTIONS_MODULE0 => "[project]/src/ai/flows/chatFlow.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
}}),
"[project]/.next-internal/server/app/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/ai/flows/chatFlow.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <exports>": ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/ai/flows/chatFlow.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3312ed22._.js.map