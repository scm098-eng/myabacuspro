...
function ProfilePage() {
    ...
    const handleCropConfirm = async ()=>{
        ...
        try {
            const croppedFile = await getCroppedImg(imgRef.current, completedCrop, 'new-photo.jpeg');
    ...
    const onSubmit = async (values)=>{
        ...
        try {
            ...
            setCroppedImageFile(null); // Reset after successful upload
        } catch (error) {
            toast({
                title: "Update Failed",
...
//# sourceMappingURL=src_fc1651e5._.js.map