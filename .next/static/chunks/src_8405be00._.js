...
const TEST_CONFIG = {
    'beads-value': {
        easy: {
            numQuestions: 20,
            timeLimit: 300,
            title: 'Beads Value (Easy)',
            icon: 'eye'
        },
        medium: {
            numQuestions: 40,
            timeLimit: 600,
            title: 'Beads Value (Medium)',
            icon: 'eye'
        },
        hard: {
            numQuestions: 60,
            timeLimit: 900,
            title: 'Beads Value (Hard)',
            icon: 'eye'
        }
    },
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "text-center my-8 md:my-12 transition-opacity duration-300",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
function BeadsTestPageClient({ testId, difficulty, settings }) {
    ...
    const goToNextQuestion = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BeadsTestPageClient.useCallback[goToNextQuestion]": ()=>{
            if (currentQuestionIndex < questions.length - 1) {
                jumpToQuestion(currentQuestionIndex + 1);
            } else {
                finishTest();
    ...
    const handleAnswerSubmit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BeadsTestPageClient.useCallback[handleAnswerSubmit]": ()=>{
            const newAnswers = [
                ...userAnswers
            ];
            newAnswers[currentQuestionIndex] = abacusValue;
            setUserAnswers(newAnswers);
            const correct = abacusValue === questions[currentQuestionIndex].answer;
            setIsCorrect(correct);
            setTimeout({
                "BeadsTestPageClient.useCallback[handleAnswerSubmit]": ()=>{
                    goToNextQuestion();
                }
            }["BeadsTestPageClient.useCallback[handleAnswerSubmit]"], correct ? 500 : 100);
        }
    }["BeadsTestPageClient.useCallback[handleAnswerSubmit]"], [
        abacusValue,
        userAnswers,
    ...
    const finishTest = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BeadsTestPageClient.useCallback[finishTest]": async ()=>{
            if (isFinished) return;
            setIsFinished(true);
            const score = userAnswers.reduce({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BeadsTestPageClient.useEffect": ()=>{
            ...
            const timer = setInterval({
                "BeadsTestPageClient.useEffect.timer": ()=>setTimeLeft({
                        "BeadsTestPageClient.useEffect.timer": (prev)=>prev - 1
                    }["BeadsTestPageClient.useEffect.timer"])
            }["BeadsTestPageClient.useEffect.timer"], 1000);
            return ({
                "BeadsTestPageClient.useEffect": ()=>clearInterval(timer)
            })["BeadsTestPageClient.useEffect"];
        }
    }["BeadsTestPageClient.useEffect"], [
        timeLeft,
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "text-center my-8 md:my-12 transition-opacity duration-300 grid grid-cols-1 md:grid-cols-2 gap-8 items-center",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(BeadsTestPageClient, "OcEghQgQO4f9bX6kmZ9ZnmSL6/k=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
...
function TestPage() {
    ...
    const TestComponent = testId === 'beads-value' ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$BeadsTestPageClient$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$TestPageClient$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"];
...
//# sourceMappingURL=src_8405be00._.js.map