...
;
;
const RazorpaySubscriptionButton = ({ userId, customerId })=>{
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RazorpaySubscriptionButton.useEffect": ()=>{
            if (!userId || !customerId) {
                setError("User or Customer ID is missing.");
                setIsLoading(false);
                return;
            }
            const loadRazorpayScript = {
                "RazorpaySubscriptionButton.useEffect.loadRazorpayScript": ()=>{
                    try {
                        const rzpForm = document.getElementById('razorpay-form');
                        if (!rzpForm) {
                            throw new Error("Razorpay form container not found.");
                        }
                        while(rzpForm.firstChild){
                        ...
                        script.onload = ({
                            "RazorpaySubscriptionButton.useEffect.loadRazorpayScript": ()=>setIsLoading(false)
                        })["RazorpaySubscriptionButton.useEffect.loadRazorpayScript"];
                        script.onerror = ({
                            "RazorpaySubscriptionButton.useEffect.loadRazorpayScript": ()=>{
                                setError("Failed to load payment script. Please check your network connection.");
                                setIsLoading(false);
                            }
                        })["RazorpaySubscriptionButton.useEffect.loadRazorpayScript"];
            ...
            return ({
                "RazorpaySubscriptionButton.useEffect": ()=>clearTimeout(timer)
            })["RazorpaySubscriptionButton.useEffect"];
        }
    }["RazorpaySubscriptionButton.useEffect"], [
        userId,
...
_s(RazorpaySubscriptionButton, "yoWkezgLLUx+hUsZPiEayeH8XVo=");
...
function PricingContent() {
    ...
    const { user, profile, isLoading, upgradeToPro, createRazorpayCustomer } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const [isCustomerReady, setIsCustomerReady] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
                    ...
                    createRazorpayCustomer().then({
                        ...
                        "PricingContent.useEffect": (err)=>{
                            toast({
                                ...
                                description: "Could not initialize payment details. Please refresh and try again.",
                                variant: "destructive"
                            });
                        }
                    }["PricingContent.useEffect"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PricingContent.useEffect": ()=>{
            ...
            if (subscriptionId && user && profile?.subscriptionStatus !== 'pro' && !isUpgrading) {
                setIsUpgrading(true);
                toast({
                ...
                const checkUpgradeStatus = {
                    "PricingContent.useEffect.checkUpgradeStatus": async (attempt = 1)=>{
                        const maxAttempts = 6;
                        try {
                            await upgradeToPro(subscriptionId);
                            toast({
                            ...
                            if (attempt < maxAttempts) {
                                setTimeout({
                                    "PricingContent.useEffect.checkUpgradeStatus": ()=>checkUpgradeStatus(attempt + 1)
                                }["PricingContent.useEffect.checkUpgradeStatus"], 5000);
                            } else {
                                toast({
                                    title: 'Upgrade Processing',
                                    description: 'Your payment was successful. If your account is not upgraded in a few minutes, please contact support.',
                                    variant: 'default'
                                });
                                setIsUpgrading(false);
                            }
                ...
                }["PricingContent.useEffect.checkUpgradeStatus"];
                setTimeout({
                    "PricingContent.useEffect": ()=>checkUpgradeStatus()
                }["PricingContent.useEffect"], 3000);
            }
        }
    }["PricingContent.useEffect"], [
        searchParams,
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardFooter"], {
                            children: isAlreadyPro ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                lineNumber: 210,
                                columnNumber: 15
                            }, this) : isUpgrading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "w-full text-center text-blue-600 font-semibold text-lg flex items-center justify-center gap-2",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                className: "w-full flex justify-center",
                                children: isCustomerReady && profile.razorpayCustomerId ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(RazorpaySubscriptionButton, {
                                    userId: user.uid,
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$skeleton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Skeleton"], {
                                            className: "h-12 w-full max-w-xs mb-2"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/pricing/page.tsx",
                                            lineNumber: 224,
                                            columnNumber: 21
...
_s1(PricingContent, "Wrrl/iVcRelbYsL6tNLK5QszpRM=", false, function() {
    return [
...
function PricingPage() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PricingContent, {}, void 0, false, {
        fileName: "[project]/src/app/pricing/page.tsx",
        lineNumber: 238,
        columnNumber: 12
    }, this);
...
//# sourceMappingURL=_508f5079._.js.map