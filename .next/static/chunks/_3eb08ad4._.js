...
;
;
const RazorpaySubscriptionButton = ({ userId })=>{
    _s();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RazorpaySubscriptionButton.useEffect": ()=>{
            const rzpForm = document.getElementById('razorpay-form');
            if (!rzpForm || !userId) return;
            if (rzpForm.firstChild) {
                rzpForm.removeChild(rzpForm.firstChild);
            }
            const script = document.createElement('script');
            script.src = 'https://cdn.razorpay.com/static/widget/subscription-button.js';
            script.async = true;
            script.setAttribute('data-subscription_button_id', 'pl_Ohp287a2N1d5gR');
            script.setAttribute('data-button_theme', 'brand-color');
            // Pass the Firebase UID in the notes
            const notes = {
                firebase_uid: userId
            };
...
_s(RazorpaySubscriptionButton, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = RazorpaySubscriptionButton;
function PricingContent() {
    ...
    const { user, profile, isLoading, upgradeToPro } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PricingContent.useEffect": ()=>{
            ...
            if (subscriptionId && !isAlreadyPro && !isUpgrading) {
                setIsUpgrading(true);
                toast({
                    title: 'Payment Successful!',
                    description: 'Verifying and upgrading your account to Pro...'
                });
                // The webhook will handle the upgrade. We just need to give it a moment
                // and then refresh the user's profile state.
                setTimeout({
                    "PricingContent.useEffect": ()=>{
                        upgradeToPro().then({
                            "PricingContent.useEffect": ()=>{
                        ...
                        }["PricingContent.useEffect"]).catch({
                            "PricingContent.useEffect": (err)=>{
                                console.error("Upgrade check failed", err);
                                toast({
                                    title: 'Upgrade Pending',
                                    description: 'We are processing your upgrade. Please refresh in a moment.',
                                    variant: 'destructive'
                                });
                            }
                        }["PricingContent.useEffect"]).finally({
                            "PricingContent.useEffect": ()=>{
                                setIsUpgrading(false);
                            }
                        }["PricingContent.useEffect"]);
                    }
                }["PricingContent.useEffect"], 5000); // Wait 5 seconds for webhook to process
            }
        }
    }["PricingContent.useEffect"], [
        searchParams,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                        ...
                        children: isAlreadyPro ? "Welcome to the Pro Club!" : "Unlock Your Full Potential"
                    }, void 0, false, {
                        fileName: "[project]/src/app/pricing/page.tsx",
                        lineNumber: 110,
                        columnNumber: 9
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: isAlreadyPro ? "You have access to all features. Keep up the great work!" : "Choose the plan that's right for you and start mastering mental math today."
                    }, void 0, false, {
                        fileName: "[project]/src/app/pricing/page.tsx",
                        lineNumber: 113,
                        columnNumber: 9
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                    className: "text-lg",
                                    children: isAlreadyPro ? "Your access to premium features is active." : "Everything you need to become a math whiz."
                                }, void 0, false, {
                                    fileName: "[project]/src/app/pricing/page.tsx",
                                    lineNumber: 123,
                                    columnNumber: 17
                                }, this),
                                !isAlreadyPro && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                className: "space-y-4",
                                children: includedFeatures.map((feature)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardFooter"], {
                            children: isAlreadyPro ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "w-full text-center text-primary font-semibold text-lg flex items-center justify-center gap-2",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$check$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Check$3e$__["Check"], {
                                        className: "w-6 h-6"
                                    }, void 0, false, {
                                ...
                                className: "w-full flex justify-center",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(RazorpaySubscriptionButton, {
                                    userId: user.uid
                                }, void 0, false, {
                                    fileName: "[project]/src/app/pricing/page.tsx",
                                    lineNumber: 153,
...
_s1(PricingContent, "cq7MOMfWKSG+OoyVEhXEHnZS1os=", false, function() {
    return [
...
function PricingPage() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Suspense"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PricingContent, {}, void 0, false, {
            fileName: "[project]/src/app/pricing/page.tsx",
            lineNumber: 166,
            columnNumber: 13
        }, this)
...
var _c, _c1, _c2;
__turbopack_context__.k.register(_c, "RazorpaySubscriptionButton");
__turbopack_context__.k.register(_c1, "PricingContent");
__turbopack_context__.k.register(_c2, "PricingPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_3eb08ad4._.js.map