...
"[project]/src/app/progress/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function ProgressReportPage() {
    _s();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$usePageBackground$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePageBackground"])('https://firebasestorage.googleapis.com/v0/b/abacusace-mmnqw.appspot.com/o/progress_bg.jpg?alt=media');
    const { user, isLoading: isAuthLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
        ...
        "ProgressReportPage.useEffect": ()=>{
            if (user) {
                const fetchTestHistory = {
                    "ProgressReportPage.useEffect.fetchTestHistory": async ()=>{
                        setIsLoading(true);
                        ...
                        const testResultsCollection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(db, 'testResults');
                        ...
                        try {
                            ...
                            querySnapshot.forEach({
                                "ProgressReportPage.useEffect.fetchTestHistory": (doc)=>{
                                    const data = doc.data();
                                    history.push({
                                        id: doc.id,
                                        ...data,
                                        createdAt: data.createdAt instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Timestamp"] ? data.createdAt.toDate() : new Date()
                                    });
                                }
                            }["ProgressReportPage.useEffect.fetchTestHistory"]);
    ...
    const chartData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProgressReportPage.useMemo[chartData]": ()=>{
            return testHistory.slice().sort({
                "ProgressReportPage.useMemo[chartData]": (a, b)=>a.createdAt.getTime() - b.createdAt.getTime()
            }["ProgressReportPage.useMemo[chartData]"]).map({
                "ProgressReportPage.useMemo[chartData]": (result)=>{
            ...
            }["ProgressReportPage.useMemo[chartData]"]).slice(-15);
        }
    }["ProgressReportPage.useMemo[chartData]"], [
        testHistory
    ]);
    const summaryStats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProgressReportPage.useMemo[summaryStats]": ()=>{
            ...
            const totalAccuracy = testHistory.reduce({
                "ProgressReportPage.useMemo[summaryStats].totalAccuracy": (acc, r)=>acc + r.accuracy
            }["ProgressReportPage.useMemo[summaryStats].totalAccuracy"], 0);
            const averageAccuracy = totalAccuracy / totalTests;
            const bestAccuracy = Math.max(...testHistory.map({
                "ProgressReportPage.useMemo[summaryStats].bestAccuracy": (r)=>r.accuracy
            }["ProgressReportPage.useMemo[summaryStats].bestAccuracy"]));
            const totalSeconds = testHistory.reduce({
                "ProgressReportPage.useMemo[summaryStats].totalSeconds": (acc, r)=>acc + r.timeSpent
            }["ProgressReportPage.useMemo[summaryStats].totalSeconds"], 0);
    ...
    if (isLoading || isAuthLoading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ProgressReportSkeleton, {}, void 0, false, {
            fileName: "[project]/src/app/progress/page.tsx",
            lineNumber: 136,
            columnNumber: 16
        }, this);
...
_s(ProgressReportPage, "E2DsYXqBq41GZkMWoF9g9btc5yA=", false, function() {
    return [
...
_c2 = ProgressReportSkeleton;
var _c, _c1, _c2;
__turbopack_context__.k.register(_c, "CustomTooltip");
__turbopack_context__.k.register(_c1, "ProgressReportPage");
__turbopack_context__.k.register(_c2, "ProgressReportSkeleton");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_6fde918d._.js.map